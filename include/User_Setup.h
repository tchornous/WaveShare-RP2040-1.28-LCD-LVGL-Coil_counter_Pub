...
#define GC9A01_DRIVER               // Display driver type
...
// sketch. e.g. with digitalWrite(TFT_BL, LOW);
 ...
 //#define TFT_BL   25             // Previously used // LED back-light control pin
 //#define TFT_BACKLIGHT_ON HIGH  // Previously used  // Level to turn ON back-light (HIGH or LOW)
...
#define TFT_MOSI 11 // MOSI/SDA pin
#define TFT_SCLK 10 // SCLK pin
#define TFT_CS   9  // Chip select control pin
#define TFT_DC   8  // Data Command control pin
#define TFT_RST  12 // Reset pin
#define TFT_BL   25 // LED back-light pin
...
//#define LOAD_GFXFF  // FreeFonts, access to 48 Adafruit_GFX fonts **
